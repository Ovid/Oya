...
def _build_repo_status(workspace_path: Path, display_path: str | None = None) -> RepoStatus:
...
async def get_repo_status(
    ...
    return _build_repo_status(settings.workspace_path, settings.display_path)
...
async def switch_workspace(
    ...
    status = _build_repo_status(resolved_path, str(resolved_path))
